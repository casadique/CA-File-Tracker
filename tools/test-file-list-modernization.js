...
assert.match(source, /\["", "active", "completed", "notChecked", "correctionRequired", "reAssigned", "nonBilled", "feePending", "feeReceived"\]\.includes\(f\.listView \|\| ""\)/,
...
assert.match(source, /\["", "active", "completed", "notChecked", "correctionRequired", "reAssigned", "nonBilled", "feePending", "feeReceived"\][\s\S]*?sortConfiguredFinancialFiles/);
