...
assert.match(source, /\["", "active", "completed", "notChecked", "correctionRequired", "nonBilled", "feePending", "feeReceived"\]\.includes\(f\.listView \|\| ""\)/,
...
assert.match(source, /\["", "active", "completed", "notChecked", "correctionRequired", "nonBilled", "feePending", "feeReceived"\][\s\S]*?sortConfiguredFinancialFiles/);
