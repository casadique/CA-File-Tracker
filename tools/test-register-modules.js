...
for (const label of ["DSC NAME","ORGANISATION","DATE & TIME","DSC TYPE","TOKEN NAME","RECEIVED FROM","MOBILE NO","BOX NAME","SLOT NO","PW","EXPIRY DATE"]) assert.match(client, new RegExp(label), `DSC In movement is missing ${label}`);
