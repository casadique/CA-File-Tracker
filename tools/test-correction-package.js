...
assert.match(app, /const fullBorder = \{ top: borderSide, right: borderSide, bottom: borderSide, left: borderSide \}/);
assert.match(app, /fill: \{ patternType: "solid", fgColor: \{ rgb: "1F4E78" \} \}/);
assert.match(app, /border: fullBorder/);
assert.match(app, /worksheet\["!rows"\]/);
